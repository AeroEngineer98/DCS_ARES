...
---------------------------------------------------------------------------------------------------------------------------------------------
	...
	{ CLSID = "{BDU-50LGB}",							arg_value = 0.0,attach_point_position = {-0.01, -0.010, 0.0}, add_mass = wingOutbdPylonMass	}, -- BDU-50LGB
...
---------------------------------------------------------------------------------------------------------------------------------------------
	...
	{ CLSID = "{BDU-50LGB}",							arg_value = 0.0,attach_point_position = {-0.05, -0.013, 0.0}, add_mass = wingInbdPylonMass	}, -- BDU-50LGB
