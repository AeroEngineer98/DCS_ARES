...
ARES =  {
	...
	SFM_Data = {
		...
		aerodynamics = -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
		{
			...
			kjx			=	0.117,  -- aileron control power coefficient / roll damping coefficient
			...
			{	--      M		Cx0		 Cya		B	B4	    Omxmax		Aldop		Cymax
				[1] = 	{0,	    0.015,	0.009,	0.175,	0,		0.5,		15,			1.17},
				[2] = 	{0.2,	0.015,	0.043,	0.175,	0,		3.197,		15,			1.17},
				[3] = 	{0.4,	0.015,	0.064,	0.175,	0,		3.014,		15,			0.935},
				[4] = 	{0.6,	0.015,	0.065,	0.175,	0,		1.910,		15,			0.875},
				[5] = 	{0.7,	0.015,	0.071,	0.175,	0,		2.242,		15,			0.845},
				...
				[10] = 	{1.1,	0.047,	0.086,	0.204,	0,		2.937,		15,			1.185},
				[11] = 	{1.2,	0.047,	0.080,	0.218,	0,		3.209,		15,			1},
				[12] = 	{1.3,	0.048,	0.074,	0.235,	0,		2.055,		15,			1},
				[13] = 	{1.5,	0.050,	0.063,	0.278,	0,		2.179,		13,			1},
				[14] = 	{1.7,	0.04,	0.051,	0.339,	0,		2.113,		12,			0.8},
				[15] = 	{1.8,	0.035,	0.046,	0.381,	0,		2.218,		11.4,		0.7},
				[16] = 	{2,	    0.025,	0.034,	0.506,	0,		2.399,		10.2,		0.6},
				[17] = 	{2.1,	0.02,	0.029,	0.606,	0,		2.47,		9.6,		0.6},
				[18] = 	{2.2,	0.015,	0.023,	0.755,	0,		0.7,		9,			0.6},
