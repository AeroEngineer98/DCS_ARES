...
ARES =  {
	...
	Picture 			= "../../../../../Mods/aircrafts/ARES/ARES.png",
	...
	{
		{
			...
			desrt    = 'ARES_destr'; -- Name of destroyed object file name
	...
	Mach_max 					= 1.0, -- Max speed in Mach (for AI)
	...
	nose_gear_pos 				= { 4.15486,	-1.58895,	0}, -- nosegear coord
	main_gear_pos 				= {-0.225224,	-1.58723,	-1.58913}, -- main gear coords
	
	tand_gear_max 				= 0.577,
	tanker_type 				= 0, -- Tanker type if the plane is airrefuel capable –- PlaneConst.lua values appear to match 0=none, 1=boom, 2=probe and drogue
	wing_area 					= 40, -- wing area in m2
	wing_span 					= 14.3, -- wing spain in m
	wing_type 					= 0,
	thrust_sum_max 				= 8000, -- thrust in kg (44kN)
	thrust_sum_ab 				= 8000, -- thrust in kg (71kN)
	length 						= 12.5, -- full lenght in m
	height 						= 3.79, -- height in m
	...
	wing_tip_pos 				=  {-3.034,	0.056, 7.156}, -- wingtip coords for visual effects
	...
	engines_nozzles = {
		[1] = 
		{
			pos 		=  {-4.953,	0.389,	0}, -- nozzle coords
			elevation   =  0, -- AFB cone elevation
			diameter	 = 0.66, -- AFB cone diameter
	...
	-- 4 Pylons, 2 on each wing
	Pylons =     {
        pylon(1, 0, -0.814055, -0.525429, -2.38891,
            {
        ...
        pylon(2, 0, -0.116029, -0.611329, -0.749062,
            {
				use_full_connector_position=true,
            },
            {
        ...
        pylon(3, 0, -0.116029, -0.611329, 0.749062,
            {
				use_full_connector_position=true,
            },
            {
		...
		------------ 
		pylon(4, 0, -0.814055, -0.525429, 2.38891,
            {
				use_full_connector_position=true,
			},
            {
	...
	DamageParts = 
	{  
--DAMAGEOFF		[1] = "ARES-part-wing-R", -- wing R
--DAMAGEOFF		[2] = "ARES-part-wing-L", -- wing L
--DAMAGEOFF		[3] = "ARES-part-nose", -- nose
--DAMAGEOFF		[4] = "ARES-part-tail", -- tail
	},
